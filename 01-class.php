            ...
            <?php
                class Vehicle {
                    ...
                    public function getAttributes() {
                        return "<div class='p-4 mb-4 flex-col ring-1 ring-white/50 bg-white/20 rounded-md'>
                ...
                $vehicle2->setAttributes('Renault', 'Sandero', 2022, 'Red');
                echo $vehicle2->getAttributes();

                $vehicle3 = new Vehicle;
                $vehicle3->setAttributes('Toyota', 'Corolla', 2021, 'Blue');
